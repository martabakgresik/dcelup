    ...
    <div className="app-container">
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '2rem', flexWrap: 'wrap' }}>
          <img src="/dcelup.jpg" alt="D'Celup Logo" style={{ width: '150px', height: '150px', borderRadius: '50%', objectFit: 'cover', border: '4px solid var(--accent-yellow)', boxShadow: '0 8px 25px rgba(0,0,0,0.5)' }} />
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', textAlign: 'left' }}>
            <h1 className="hero-title">{settings.header_title || "D'CELUP"}</h1>
            <h2 className="hero-subtitle">
              {String(settings.header_subtitle || "Chicken Crispy").toLowerCase().replace(/\b\w/g, c => c.toUpperCase())}
            </h2>
          </div>
        </div>
