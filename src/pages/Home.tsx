    ...
    <div className="app-container">
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1.2rem', marginBottom: '0.5rem', flexWrap: 'wrap' }}>
          <img src="/dcelup.jpg" alt="D'Celup Logo" style={{ width: '120px', height: '120px', borderRadius: '50%', objectFit: 'cover', border: '3px solid var(--accent-yellow)', boxShadow: '0 8px 20px rgba(0,0,0,0.4)' }} />
